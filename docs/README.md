...
2014 年 4 月に日本郵便株式会社へ入社し、郵便配達員として郵便物の配達および各種郵便商品の営業活動に従事。
...
現在、外部 API へクオータ制限の拡張を申請中につき、新規 Spotify ユーザーの登録はテストユーザー以外行えません。アプリケーションへのユーザー登録は email サインアップをお試しください。
...
- **プログラミング学習**: 未経験から学び始め、学習開始から 5 ヶ月半で個人開発の音楽共有アプリ「Mixtones」をリリース
